...
<head>
    ...
    <title>Daftar Buku - PerpusLab Nusantara</title>

    <meta name="csrf-token" content="{{ csrf_token() }}">
    <link rel="shortcut icon" href="{{ asset('assets') }}/img/perpus.svg" type="image/x-icon">
...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Daftar buku</h3>
                            <p class="text-subtitle text-muted">Kelola buku dengan mudah menggunakan tabel interaktif.
                            </p>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <form class="form form-vertical" id="editbukuForm"
                                                                method="post"
                                                                action="{{ route('buku.update', ['id' => $buku->id]) }}"
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-body">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label for="tanggal_terbit">Tanggal
                                                                                        Terbit</label>
                                                                                    <input type="date"
                                                                                        id="tanggal_terbit"
                                                                                        class="form-control"
                                                                                        name="tanggal_terbit"
                                                                                        value="{{ $buku->tanggal_terbit }}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-12">
                                                                                <div class="form-group">
                                                                                    <label
                                                                                        for="penerbit">Penerbit</label>
                                                                                    <input type="text"
                                                                                        id="penerbit"
                                                                                        class="form-control"
                                                                                        name="penerbit"
                ...
                <!-- Modal -->
                <div class="modal fade" id="bukuModal" tabindex="-1" aria-labelledby="bukuModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form class="form form-vertical" id="bukuForm" method="post"
                                action="{{ route('buku.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="modal-header">
                                    <h5 class="modal-title" id="bukuModalLabel">Tambah Buku Baru</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="intro">Tanggal Terbit</label>
                                                    <input type="date" id="intro" class="form-control"
                                                        name="tanggal_terbit" placeholder="Intro Kelas"></input>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="deskripsi">Penerbit</label>
                                                    <input id="deskripsi" class="form-control" name="penerbit"
                                                        placeholder="Deskripsi Kelas"></>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label for="deskripsi">Pengarang</label>
                                                    <input id="deskripsi" class="form-control" name="pengarang"
                                                        placeholder="Deskripsi Kelas"></input>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
    ...
    <script>
        function viewFoto(namaFoto) {
            var fotoUrl = '{{ asset('storage/foto-buku') }}/' + namaFoto;
