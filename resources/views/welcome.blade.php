...
<body class="index-page">
    ...
    <main class="main">
                  ...
                  "spaceBetween": 120
                    ...
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-1.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-2.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-3.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-4.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-5.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-6.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-7.png" class="img-fluid"
                                alt=""></div>
                        <div class="swiper-slide"><img
                                src="{{ asset('assets/landing_page') }}/img/clients/client-8.png" class="img-fluid"
                                alt=""></div>
                    </div>
        ...
        <section id="services" class="services section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Daftar Buku</h2>
                <p>Pilih Buku yang Anda Inginkan<br></p>
            </div><!-- End Section Title -->
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    {{-- <div class="col-lg-3 col-md-6 content-book" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="container">
                        <div class="card-border">
                            <div class="card">
                                <div class="content">
                                    ...
                                    <p class="text">We've asked visitors and checked in with locals to find the best
                                        places and things to do on your New Zealand holiday.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-border">
                            <div class="card">
                                <div class="content">
                                    <h2 class="title">Weather and seasons</h2>
                                    <p class="text">Find out more about New Zealand weather patterns and learn more
                                        about typical temperatures for seasons. Find out what to wear for each climate.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-border">
                            <div class="card">
                                <div class="content">
                                    <h2 class="title">Home of middle-earth</h2>
                                    <p class="text">Ever since the first The Lord of the Rings movie was released in
                                        2001, New Zealand has been known as the 'Home of Middle‑earth™</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                <div class="row gx-0">
                    ...
                    <div class="col-lg-6 d-flex align-items-center" data-aos="zoom-out" data-aos-delay="200">
                        <img src="{{ asset('assets/landing_page') }}/img/about.jpg" class="img-fluid"
                            alt="">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-6" data-aos="zoom-out" data-aos-delay="100">
                        <img src="{{ asset('assets/landing_page') }}/img/features.png" class="img-fluid"
                            alt="">
                    </div>
            ...
            <div class="container">
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-5 d-flex align-items-center order-1 order-xl-2" data-aos="fade-up"
                        data-aos-delay="100">
                        <img src="{{ asset('assets/landing_page') }}/img/alt-features.png" class="img-fluid"
                            alt="">
                    </div>
                    ...
                    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/app-1.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>App 1</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/app-1.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/product-1.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Product 1</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/product-1.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/branding-1.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Branding 1</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/branding-1.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/books-1.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Books 1</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/books-1.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/app-2.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>App 2</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/app-2.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/product-2.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Product 2</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/product-2.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/branding-2.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Branding 2</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/branding-2.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/books-2.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Books 2</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/books-2.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/app-3.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>App 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/app-3.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/product-3.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Product 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/product-3.jpg"
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/branding-3.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Branding 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/branding-3.jpg"
                                        title="Branding 2" data-gallery="portfolio-gallery-branding"
                                        class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                                    <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                            class="bi bi-link-45deg"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
                            <div class="portfolio-content h-100">
                                <img src="{{ asset('assets/landing_page') }}/img/portfolio/books-3.jpg"
                                    class="img-fluid" alt="">
                                <div class="portfolio-info">
                                    <h4>Books 3</h4>
                                    <p>Lorem ipsum, dolor sit amet consectetur</p>
                                    <a href="{{ asset('assets/landing_page') }}/img/portfolio/books-3.jpg"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('assets/landing_page') }}/img/testimonials/testimonials-1.jpg"
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('assets/landing_page') }}/img/testimonials/testimonials-2.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>Sara Wilsson</h3>
                                    <h4>Designer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('assets/landing_page') }}/img/testimonials/testimonials-3.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>Jena Karlis</h3>
                                    <h4>Store Owner</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('assets/landing_page') }}/img/testimonials/testimonials-4.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>Matt Brandon</h3>
                                    <h4>Freelancer</h4>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                ...
                                <div class="profile mt-auto">
                                    <img src="{{ asset('assets/landing_page') }}/img/testimonials/testimonials-5.jpg"
                                        class="testimonial-img" alt="">
                                    <h3>John Larson</h3>
                                    <h4>Entrepreneur</h4>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ asset('assets/landing_page') }}/img/team/team-1.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ asset('assets/landing_page') }}/img/team/team-2.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ asset('assets/landing_page') }}/img/team/team-3.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up"
                        ...
                        <div class="team-member">
                            <div class="member-img">
                                <img src="{{ asset('assets/landing_page') }}/img/team/team-4.jpg" class="img-fluid"
                                    alt="">
                                <div class="social">
                                    <a href=""><i class="bi bi-twitter-x"></i></a>
                                    <a href=""><i class="bi bi-facebook"></i></a>
                ...
                <div class="row gy-5">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('assets/landing_page') }}/img/blog/blog-1.jpg" class="img-fluid"
                                    alt="">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="post-item position-relative h-100" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('assets/landing_page') }}/img/blog/blog-2.jpg" class="img-fluid"
                                    alt="">
                    ...
                    <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="post-item position-relative h-100">
                            ...
                            <div class="post-img position-relative overflow-hidden">
                                <img src="{{ asset('assets/landing_page') }}/img/blog/blog-3.jpg" class="img-fluid"
                                    alt="">
